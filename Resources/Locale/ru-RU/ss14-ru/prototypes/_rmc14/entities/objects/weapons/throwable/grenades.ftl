...
ent-CMGrenadeFragOld = осколочная граната M15
    .desc = Устаревшая осколочная граната КООН. Прослужив несколько десятилетий в КМП ООН, старая осколочная граната M15 постепенно заменяется более безопасными гранатами серии M40. Она срабатывает через 4 секунды.
